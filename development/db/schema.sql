create sequence hibernate_sequence start 1 increment 1;
    ...
    alter table if exists bartender 
       add constraint FKrriold829ilpiungxpau2iomq 
       foreign key (user_id) 
       references person;

    alter table if exists bill 
       add constraint FKcdveik90g4pvk7m249scu73pg 
    ...
    alter table if exists customer 
       add constraint FK3hnutqe63n4hp8qda9vp5yxd7 
       foreign key (user_id) 
       references person;

    alter table if exists "order" 
       add constraint FK65ngp9nfr0jp3nrta80k7g3vu 
       foreign key (bartender_user_id) 
    ...
    alter table if exists session_bartender 
       add constraint FKs9hrjajhvlbe354djdr4nus4a 
       foreign key (id) 
       references session;

    alter table if exists session_bartender 
       add constraint FKdwtnwd7rj67yrria9seq3n9km 
       foreign key (user_id) 
       references bartender;
