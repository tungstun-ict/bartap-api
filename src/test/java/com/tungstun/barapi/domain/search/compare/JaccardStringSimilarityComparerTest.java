...
class JaccardStringSimilarityComparerTest {
    private JaccardStringSimilarityComparer comparer;
    ...
    @BeforeEach
    void setUp() {
        comparer = new JaccardStringSimilarityComparer();
    }
    ...
    void apply(String left, String right, Double expectedIndex) {
        Double index = comparer.apply(left, right);
    ...
    void applyAll() {
        Double index = comparer.applyAll("word", "ape", "word", "worp");
    ...
    void applyAllNoMatch() {
        Double index = comparer.applyAll("word", "ape", "pp", "lazy");
