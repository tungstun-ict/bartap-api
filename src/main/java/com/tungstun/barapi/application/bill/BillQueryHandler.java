...
//                .findFirst()
//                .orElseThrow(() -> new EntityNotFoundException(String.format("No bill with categoryId: %s was found in session with categoryId:  %s", billId, sessionId)));
//    }
//
...
//                .findFirst()
//                .orElseThrow(() -> new EntityNotFoundException("No bill in session for given customer with categoryId" + personId));
//    }
//
...
//                .filter(bill -> bill.getId().equals(billId))
//                .findFirst()
//                .orElseThrow(() -> new EntityNotFoundException(String.format("No bill found with categoryId '%s' for customer in bar", billId)));
//    }
